...
# Build only the scull subdirectory; pass LDDINC explicitly so the scull Makefile
# finds the ldd3 include/ headers (proc_ops_version.h, access_ok_version.h, etc.)
...
do_install () {
	...
	install -m 0755 ${WORKDIR}/scull ${D}${sysconfdir}/init.d/scull
}
